...
// NaN/Infinity (review finding, round 2) would otherwise survive
// Math.min/Math.max and produce a literal "width: NaN%"/"width:
// Infinity%" -- treated as 0 rather than propagated.
