...
// Review finding, PR #182: item.share is a plain caller-supplied
// number with no runtime guarantee it's actually 0-100 -- bad data or
// a rounding error upstream would otherwise render a negative or
// overflowing bar. Clamped here rather than trusting every caller.
// NaN/Infinity would otherwise survive Math.min/Math.max and produce a
// literal "width: NaN%"/"width: Infinity%" -- treated as 0 rather than
// propagated.
