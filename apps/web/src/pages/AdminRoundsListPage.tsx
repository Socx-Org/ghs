...
import type { AdminRoundListItem, RoundStatus } from "../types/domain";
...
// own search/filter (ghs#137); pagination is #138, a separate, still-open
// issue, not yet added here.

// ghs#137: mirrors RoundStatusBadge's own labels.
